...
binaries = []
hiddenimports = ['selenium', 'dotenv', 'psutil', 'pyperclip', 'pytz', 'zoneinfo', 'requests', 'urllib3', 'certifi', 'sklearn', 'sklearn.ensemble', 'sklearn.ensemble._hist_gradient_boosting', 'sklearn.neural_network', 'sklearn.pipeline', 'sklearn.preprocessing', 'sklearn.impute', 'joblib', 'trader_companion.signals.ml_direction', 'trader_companion.signals.prediction_tracker', 'trader_companion.signals.trade_simulator', 'trader_companion.signals.trade_learning_journal', 'trader_companion.signals.indicator_optimizer', 'trader_companion.signals.price_data', 'signals.ml_direction', 'signals.prediction_tracker', 'signals.trade_simulator', 'signals.trade_learning_journal', 'signals.indicator_optimizer', 'signals.price_data']
