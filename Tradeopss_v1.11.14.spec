...
binaries = []
hiddenimports = ['selenium', 'dotenv', 'psutil', 'pyperclip', 'pytz', 'zoneinfo', 'requests', 'urllib3', 'certifi', 'playwright', 'playwright.async_api', 'playwright.sync_api', 'connectors.alphatrader_connector']
