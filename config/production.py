...
class Config:
    ...
    APP_VERSION = '1.0.1'
    # Empty = companion version gate off (older exes allowed). Set to trader_app
    # APP_VERSION when shipping a mandatory TradeOpssAI release.
    REQUIRED_COMPANION_VERSION = os.getenv('REQUIRED_COMPANION_VERSION', '')
