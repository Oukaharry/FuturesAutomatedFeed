...
### Overview
This is the first official release of the MT5 Trader Companion desktop application. The app is designed to help traders easily push their MT5 trading data to the TradeOpps dashboard and manage essential trading operations from a simple, user-friendly interface.
...
- **Read-Only Dashboard URL**: The dashboard URL is hardcoded to https://www.tradeopss.com for security and simplicity.
...
3. All data is sent securely to the TradeOpps dashboard.
