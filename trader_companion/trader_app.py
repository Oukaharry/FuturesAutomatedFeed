...
APP_VERSION = "1.11.16"  # Set config/production.py REQUIRED_COMPANION_VERSION on mandatory releases
    ...
    def _populate_broker_rows(self, evaluations, prop_accounts):
        ...
        for firm in firms:
            ...
            if not pa:
                ...
                _FIRM_ALIASES = {
                    "funded next": ["fundednext", "funded next flex", "fundednextflex",
                                    "fundednext rapid daily", "fundednextrapiddaily"],
                    "fundednext": ["funded next", "funded next flex", "fundednextflex",
                                   "fundednext rapid daily", "fundednextrapiddaily"],
                    "funded next flex": ["fundednextflex", "funded next", "fundednext",
                                          "fundednext rapid daily", "fundednextrapiddaily"],
                    "fundednextflex": ["funded next flex", "funded next", "fundednext",
                                       "fundednext rapid daily", "fundednextrapiddaily"],
                    "fundednext rapid daily": ["fundednextrapiddaily", "funded next",
                                               "fundednext", "funded next flex", "fundednextflex"],
                    "fundednextrapiddaily": ["fundednext rapid daily", "funded next",
                                              "fundednext", "funded next flex", "fundednextflex"],
                    "tradeify": ["tradeify (50% add-on)", "tradeify select"],
                    "tradeify (50% add-on)": ["tradeify", "tradeify select"],
                    "tradeify select": ["tradeify", "tradeify (50% add-on)"],
                    "my funded futures": ["mffu"],
                    "mffu": ["my funded futures"],
                    "lucid": ["lucid trading"],
                    "lucid trading": ["lucid"],
